...
//};
//
//template <class T> std::string util::io::printStr(const std::vector<T> &list, int nt =
//0) {
//
...
//};
//
//template <class T> void util::io::print(const std::vector<T> &list, int nt = 0) {
//
...
// */
//
//std::string util::io::printBoxStr(const std::pair<util::Point3, util::Point3> &box, int nt =
//0) {
//  auto tabS = getTabS(nt);
//  std::ostringstream oss;
